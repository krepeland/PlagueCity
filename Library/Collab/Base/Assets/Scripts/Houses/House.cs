...
public class House : MonoBehaviour, ITickable
{
    ...
    void Start() {
        ...
        GetComponent<MeshRenderer>().material.SetTexture("Texture2D_c66bb91ef604482d8657f70ebb2100ec", MaterialManager.singleton.GetRandomHouseTexture());
    ...
    void ProcessOuterInfection(short infection, int luck)
    {
        ...
        foreach (var house in houses) {
            ...
            var rayObstacles = Physics2D.RaycastAll(transform.position, house.collider.transform.position, distance);
            var Power = 3;
